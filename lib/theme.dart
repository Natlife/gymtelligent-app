...
final ValueNotifier<ThemeData> appThemeNotifier = ValueNotifier<ThemeData>(AppTheme.darkTheme);
...
class AppTheme {
  ...
  static final Color textSecondaryLight = const Color(0xFF1E293B).withOpacity(0.65);
  static final Color borderLightLight = const Color(0xFF1E293B).withOpacity(0.12);
  ...
  static Color getTextColor(BuildContext context) {
    return Theme.of(context).brightness == Brightness.dark ? Colors.white : textPrimaryLight;
  }
  ...
  static Color getActiveBorderColor(BuildContext context) {
    ...
    return isLight ? const Color(0xFF059669) : gradientStart; // Deep Emerald for Light, Neon Green for Dark
  }
